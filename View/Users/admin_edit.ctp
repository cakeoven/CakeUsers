...
<div class="row">
	<div class="col-md-9 col-lg-9">
		...
		<?php echo $this->Form->chosen('group_id', array('empty' => false));?>
		<ul class="nav nav-tabs" role="tablist">
			<li class="active"><?php echo $this->Html->link(__('General'), '#general', array("data-toggle" => 'tab', 'role' => 'tab'));?></li>
			<li><?php echo $this->Html->link(__('Calendar'), '#calendar', array("data-toggle" => 'tab', 'role' => 'tab'));?></li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="calendar">
				<?php echo $this->Form->input('calendar_background_color', array('label' => __('Background Color')));?>
				<?php echo $this->Form->input('calendar_font_color', array('label' => __('Font Color')));?>
			</div>

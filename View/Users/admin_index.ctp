<?php $this->Html->addCrumb($this->Html->link(__('Users'), array('action' => 'index'),
    ...
    <div class="toolbar toolbar-default">
        ...
        <?php echo $this->Html->link(__('Add'), array('action' => 'add'),
            array('class' => 'btn btn-success btn-sm', 'icon' => 'plus')); ?>
        <div class="btn-group">
            <?php echo $this->Html->link(__('ACL'), '/acl/permissions',
                array('class' => 'btn btn-info btn-sm', 'icon' => 'filter')); ?>
            <?php echo $this->Html->button('', array(
                'class' => 'btn btn-info btn-sm dropdown-toggle',
                'data-toggle' => 'dropdown',
                'icon' => 'caret-down'
            )); ?>
            <ul class="dropdown-menu">
                <li><?php echo $this->Html->link(__('Update ACOs'), array(
                        'admin' => false,
                        'plugin' => 'acl_manager',
                        'controller' => 'acl',
                        'action' => 'update_acos'
                    ), array('icon' => 'refresh')); ?></li>
                <li><?php echo $this->Html->link(__('Update AROs'), array(
                        'admin' => false,
                        'plugin' => 'acl_manager',
                        'controller' => 'acl',
                        'action' => 'update_aros'
                ...
                <li class="divider"></li>
                <li><?php echo $this->Html->link(__('Drop ACO/ARO'),
                        array('admin' => false, 'plugin' => 'acl_manager', 'controller' => 'acl', 'action' => 'drop'),
                        array('icon' => 'eraser')); ?></li>
                <li><?php echo $this->Html->link(__('Drop Permisions'), array(
                        'admin' => false,
                        'plugin' => 'acl_manager',
                        'controller' => 'acl',
                        'action' => 'drop_perms'

...
<div class="row">
	<div class="col-sm-2">
		<div class="list-group">
			...
			<?php echo $this->Html->link(__('Renew Token'), array('action' => 'renewToken', $user['User']['id']), array('class' => 'list-group-item', 'icon' => array('class' => 'icon icon-refresh icon-fw')));?>
			<?php echo $this->Html->link(__('Renew Token Email'), array('action' => 'renewTokenEmail', $user['User']['id']), array('class' => 'list-group-item', 'icon' => array('class' => 'icon icon-refresh icon-fw')));?>
		</div>
	</div>
	<div class="col-sm-10">
		...
		<ul class="nav nav-tabs nav-tabs-remote">
			<li class="active"><?php echo $this->Html->link(__('Logins'), array('controller' => 'logins', 'action' => 'related', 'user_id' => $user['User']['id']), array('data-toggle' => 'tab', 'data-target' => '#related-logins'))?></li>
		</ul>

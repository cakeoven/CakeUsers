...
<ul class="nav nav-tabs">
	<li class="active"><?php echo $this->Html->link(__('Logins'), '#related-logins', array("data-toggle" => "tab"))?></li>
</ul>
<div class="tab-content">
	<div id="related-logins" class="tab-pane active">
		<?php echo $this->requestAction(array('controller' => 'logins', 'action' => 'related', '?' => array('user_id' => $user['User']['id'])), array('return'));?>
	</div>
</div>
